...
\frame{\frametitle{QuickCheck}
  \begin{itemize}
    ...
    \item You specify pre- and post-conditions 
    \item Let computer generate input data
  \end{itemize}
}
...
\frame{\frametitle{QuickCheck History}
  \begin{itemize}
    ...
    \item Re-implementations of QuickCheck exist for Java, Scala, Clojure, Groovy, ...
  \end{itemize}
}
